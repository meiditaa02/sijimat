// app/profile/page.jsx (atau app/(dashboard)/profile/page.jsx sesuai struktur proyekmu)
...
import NotificationSettingForm from '../../components/NotificationSettingForm' // ← BARU IMPOR DI SINI
...
const roleDescription = {
  admin: 'Kamu bisa Kelola jadwal tarawih, akun imam, dan membalas pesan masuk.',
  imam: 'Kamu bisa melihat jadwal tugasmu dan memperbarui data diri sebagai imam.',
  user: 'Kamu bisa melihat jadwal tarawih publik dari masjid yang terdaftar.',
}
      ...
      <main style={{ minHeight: '100vh', background: '#f6f8f7', padding: '2.5rem 1.25rem' }}>
        <div style={{ maxWidth: '880px', margin: '0 auto', display: 'grid', gap: '1.25rem' }}>
          ...
          <section style={{
            ...
            <div style={{ display: 'flex', gap: '1.25rem', alignItems: 'center', flexWrap: 'wrap', position: 'relative' }}>
              ...
              <div style={{ flex: 1, minWidth: '200px' }}>
                ...
                <h1 style={{ fontSize: '1.55rem', fontWeight: '800', margin: 0, lineHeight: 1.2 }}>
                  {displayName}
                </h1>
                <p style={{ margin: '0.4rem 0 0', fontSize: '0.9rem', color: 'rgba(255,255,255,0.85)', maxWidth: '460px' }}>
                  {roleDescription[role] || roleDescription.user}
                </p>
              </div>
            </div>
          ...
          <section style={{
            ...
            <h2 style={{ color: '#111827', fontSize: '1rem', fontWeight: '800', marginBottom: '0.25rem' }}>
              Detail Akun
            </h2>
            <p style={{ color: '#6b7280', fontSize: '0.85rem', marginBottom: '1.1rem' }}>
              Informasi dasar yang terhubung dengan akunmu.
            </p>
          ...
          {/* DATA IMAM TERHUBUNG — hanya untuk role imam */}
          {role === 'imam' && (
            <section style={{
              background: 'white',
              border: '1px solid #e5e7eb',
              ...
              <div style={{ marginBottom: '1.1rem' }}>
                ...
                <p style={{ color: '#6b7280', fontSize: '0.85rem', margin: 0 }}>
                  Hubungkan akunmu dengan data imam agar jadwal tarawihmu muncul otomatis.
                </p>
              </div>
              ...
              {!imamProfiles?.length ? (
                <div style={{
                  ...
                  <p style={{ color: '#374151', fontWeight: '700', margin: '0 0 0.3rem' }}>
                    Belum ada data imam yang terhubung
                  </p>
                  <p style={{ color: '#6b7280', fontSize: '0.85rem', margin: '0 0 1rem' }}>
                    Isi data imam lalu jadwal tugasmu akan tampil otomatis di dashboard.
                  </p>
                  <Link
                    href="/daftar-imam"
                    style={{
          ...
          <section style={{
            ...
            <p style={{ color: '#6b7280', fontSize: '0.85rem', marginBottom: '1.1rem' }}>
              Kelola keamanan dan preferensi akunmu.
            </p>
...
function InfoCard({ label, value }) {
  return (
    <div style={{ background: '#f9fafb', border: '1px solid #f3f4f6', borderRadius: '12px', padding: '0.9rem' }}>
      <div style={{ color: '#6b7280', fontSize: '0.76rem', fontWeight: '800', marginBottom: '0.3rem', textTransform: 'uppercase', letterSpacing: '0.03em' }}>
        {label}
      </div>
